...
<img src="../assets/multicam_battery_lcd.jpg" width="400" alt="Complete Setup">
...
> **Note**: this tutorial demonstrates all steps on a Jetson Orin Nano Development Board, a similar setup is also available for the Jetson AGX and Thor Orin Development Kits. Refer to the 3D-printed frames and the step-by-step assembly schematics for AGX ([frame](../assets/3rs_435-55_Orin_AGX.stl), [schema](../assets/assembly_guide_agx.png)) and Thor ([frame](../assets/3rs_435-55_Thor.stl), [schema](../assets/assembly_guide_thor.png)).

This configuration sets up one camera as the primary device, providing synchronization signals to the dependent cameras. The setup uses standard jumper wires, connectors, and a breadboard for easy, solder-free assembly. For more details and additional synchronization options, please refer to the [official RealSense multicamera documentation](https://www.realsenseai.com/stereo-depth/multiple-depth-cameras-setup-guide/)
...
- **M3x6 screws** (6x) for d435 or **M4x6 screws** (6x) for d455
...
- **Remove the plastic frame from the Jetson Nano Developer Kit**
  ...
  *Tip: Remember to detach the WiFi antenna before removal. Reattach it to the M2 modem after completing the assembly in Step 5*
  <img src="../assets/jetson_no_frame.jpg" width="400" alt="Jetson without frame">
...
- **Connect AWG wires to JST connectors**:
  ...
  *Tip: Connect JST connectors to RealSense cameras after completing assembly in Step 5*
  <img src="../assets/rs_connector.jpg" width="800" alt="RealSense Connector">
...
- **Assemble synchronization module on BreadBoard Mini**:
  ...
  <img src="../assets/sync_module_real.jpg" width="800" alt="RealSense Connector Module">

  >**Note**: If using only 2 cameras, you can connect them directly (see the right-side photo) - ensure the corresponding pins match
...
<img src="../assets/jetson_with_cameras.jpg" width="600" alt="Jetson Setup with Cameras">

## Additional Notes

- **Camera compatibility:** all available 3D printed frames (for [Nano](../assets/3rs_435-55_Orin_Nano.stl), [AGX](../assets/3rs_435-55_Orin_AGX.stl), [Thor](../assets/3rs_435-55_Thor.stl)) support mounting RealSense D435 or D455 cameras - choose whichever option suits your needs
